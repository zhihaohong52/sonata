---
name: code-deepseek-v4-flash
description: Delegates implementation, refactors, and mechanical code changes to deepseek-v4-flash running under opencode. Use when this work should run on deepseek-v4-flash rather than Claude — typically to save cost on bulk work, or to get a different model's judgement.
model: haiku
tools: Bash
---

...
```jsonc
{
  ...
  "attempts": [{ "key": "vendorx-gemini-3.7-flash", "status": 403 }],
...
```toml
[models."vendorx-deepseek-v4-flash-0731".price]      # USD per 1M tokens
input = 0.44
cached_input = 0.014
output = 1.32

[[models."vendorx-deepseek-v4-flash-0731".price.windows]]
...
vendorx-deepseek-v4-flash      308   1.4M        44k     $0.68
...
cooling  vendorx-gemini-3.7-flash (403, 41s left)

recent routes
  sonata-explore-simple  vendorx-gemini-3.7-flash 403 → gpt-5.6-luna 200   1.6k/11
  sonata-code-simple     vendorx-deepseek-v4-flash 200                     8.2k/302
```
